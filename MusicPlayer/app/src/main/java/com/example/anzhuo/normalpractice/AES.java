...
public class AES {
    ...
    public static String getText(Object input) {
        if(input instanceof Integer){
            return "{\"ids\":[" + input + "],\"br\":999000,\"csrf_token\":\"\"}";
        }
        if(input instanceof String){
            return  "{\"s\":" + "\"" + input + "\"" + "," + "\"type\":1,\"limit\":30}";
        }
        return null;
    }
    ...
    public static String[] getParams(int id) {
        String content = getText(id);
        // "7b104953fb112826"
        ...
        String param="params="+encText+"&encSecKey="+encSecKey;
//        Log.e("post",param);
        String[] params={encText,encSecKey};
        return params;
    }
